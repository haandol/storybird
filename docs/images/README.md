...
| `voice-settings-app.png` | Real SwiftUI Voice settings in a synthetic native window, empty profile list and model selector |
...
Voice settings/model selection images were regenerated by the test harness on 2026-09-11.
