...
| Grant OS permissions or accept native capture/deletion prompts | The user approves in macOS/Storybird; tool calls do not supply consent | [Permissions](adr/recording/0003-permission-and-signing.md) |
