...
| `custom-voice-generation.png` | Profile-free built-in voice form with speaker, optional instructions, language and text |
| `custom-voice-editing.png` | Synthetic narration editing content with retained speaker and instructions; native sheet toolbar is outside this content render |
...
Regenerate these CustomVoice images with
`STORYBIRD_UPDATE_DOC_SCREENSHOTS=1 swift test --filter DocumentationScreenshotTests/test_generateCustomVoiceScreenshots`.
