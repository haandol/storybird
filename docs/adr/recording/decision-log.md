...
- **Current ADR**: [0003-permission-and-signing](./0003-permission-and-signing.md)
- **Change type**: requirement rule change
- **What**: 프로필 샘플에 한정한 마이크 사용 → 사용자가 시작하는 독립 프로젝트 음성 녹음도 허용.
...
## 2026-09-08 — 음성 프로필 녹음과 모델 다운로드를 별도 승인 경계로 추가

- **현재 ADR**: [permission-and-signing](./0003-permission-and-signing.md)
- **변경 유형**: 권한 규칙 변경
- **무엇이**: 마이크를 사용하지 않던 권한 경계에 사용자 시작 음성 프로필 녹음과 사용자 승인
  최초 모델 다운로드를 추가하고 화면 녹화·MCP 자동화와 분리했다.
- **왜**: 화면 녹화의 무음 계약을 유지하면서 본인 음성 복제 입력을 로컬에서 만들어야 한다.
